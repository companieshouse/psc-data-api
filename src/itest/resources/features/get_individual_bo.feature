Feature: Get individual
  ...
  Scenario Outline: Get individual successfully
    ...
    And a PSC "<data>" exists for "<company_number>" for Individual Beneficial Owner
    ...
    Examples:
      ...
      | get_individual_bo | 34777772       | ZfTs9WeeqpXTqf6dc6FZ4C0H0ZX | get_individual_bo_output |
  ...
  Scenario Outline: Get Individual when sending get request without Eric headers
    ...
    Examples:
      ...
      | get_individual_bo | 34777772       | ZfTs9WeeqpXTqf6dc6FZ4C0H0ZX |
  ...
  Scenario Outline: Get PSC unsuccessfully - PSC resource does not exist
    ...
    Examples:
      ...
      | 34777772       | ZfTs9WeeqpXTqf6dc6FZ4C0H0ZX |
