Feature: Get Legal Person
  ...
  Scenario Outline: Get individual successfully
    ...
    And a PSC "<data>" exists for "<company_number>" for Legal Person
    ...
    Examples:
      ...
      | get_legal_person | 34777775       | ZfTs9WeeqpXTqf6dc6FZ4C0H0ZV | get_legal_person_output |
  ...
  Scenario Outline: Get Legal Person when sending get request without Eric headers
    ...
    Examples:
      ...
      | get_legal_person | 34777775       | ZfTs9WeeqpXTqf6dc6FZ4C0H0ZV |
